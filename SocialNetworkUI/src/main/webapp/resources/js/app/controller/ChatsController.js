    ...
    var advertCtrl = (function () {
        ...
        var methods = {
            ...
            bindEvents: function () {
                ...
                $('#contentContainer').delegate('button.goToChat', 'click', function () {
                    var chatId = this.getAttribute("chat");
                    currentChatId = chatId;
                    var msgTable = $('#msgTable');
                    var msgTableOptions = msgTable.bootstrapTable('getOptions');
                    msgTableOptions.url = '/api/chats/messages/' + chatId;
                    msgTable.bootstrapTable('refreshOptions', msgTableOptions);
                    msgTable.bootstrapTable('refresh');
                });
                $('#sendMsg').click(function() {
                    var msg = $('#inputMsg').val();
                    UserService.sendMessage(msg, currentChatId, $('#msgTable'));
                    $('#inputMsg').val("");
                });
