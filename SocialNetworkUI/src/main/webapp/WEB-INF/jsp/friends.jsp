...
<head>
    ...
    <title><spring:message code="msg.friends"/></title>
    ...
    <script type="text/javascript" src="<c:url value="/resources/js/app/controller/FriendController.js" />"></script>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="responsive-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="/chats"><spring:message code="msg.chats"/></a></li>
                        <li><a href="/communities"><spring:message code="msg.communities"/><span class="badge">${cart.size()}</span></a></li>
...
<div class="container">
    <div class="row">
        <h3><spring:message code="msg.friends"/></h3>
    </div>
</div>
            ...
            <c:if test="${currentUser.id != 0}">
                ...
                >
                    ...
                    <tr>
                        ...
                        <th data-field="id" data-formatter="LinkFormatter" data-align="center">Create chat</th>
                    </tr>
                    </thead>
                    <tbody>
                    </tbody>
...
<script>
    function LinkFormatter(value, row, index) {
        return "<button type=\"button\" class=\"btn btn-primary createChat\" friend=\"" + value + "\">Создать чат</button>";
    }
</script>
