...
<head>
    ...
    <title><spring:message code="msg.chats"/></title>
    ...
    <script type="text/javascript" src="<c:url value="/resources/js/app/controller/ChatsController.js" />"></script>
...
<div class="container">
    <div class="row">
        <h3><spring:message code="msg.chats"/></h3>
    </div>
</div>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 col-lg-5" id="contentContainer">
            <c:if test="${currentUser.id != 0}">
                <table class="table table-no-bordered" id="table1" data-toggle="table"
                       data-classes="table table-no-bordered"
                       data-click-to-select="true"
                       data-url="/api/users/chats"
                       data-side-pagination="client"
                       data-pagination="true"
                       data-page-size="5"
                       data-page-list="[5, 15, 25, 35]"
                       data-search="true"
                ...
                >
                    <thead>
                    <tr>
                        <th data-field="chatName" data-align="center"><spring:message code="msg.chatName"/></th>
                        <th data-field="id" data-formatter="LinkFormatter" data-align="center"><spring:message code="msg.goToChat"/></th>
                    </tr>
                    </thead>
                    <tbody>
                    </tbody>
        ...
        <div class="col-md-6 col-lg-6" id="messagesContainer">
            <c:if test="${currentUser.id != 0}">
                <table class="table table-no-bordered custom-table-body" id="msgTable" data-toggle="table"
                       data-classes="table table-no-bordered"
                       data-click-to-select="true"
                       data-url="/api/users/chats"
                       data-side-pagination="client"
                ...
                >
                    <thead>
                    <tr>
                        <th data-field="login" data-align="center" width="20%"><spring:message code="msg.owner"/></th>
                        <th data-field="message" data-align="center" width="80%"><spring:message code="msg.message"/></th>
                    </tr>
                    </thead>
                    <tbody>
                    </tbody>
                </table>
                <textarea name="inputMsg" id="inputMsg" cols="40" rows="3"></textarea></p>
                <button type="button" class="btn btn-primary" id="sendMsg"><spring:message code="msg.sendMsg"/></button>
...
<script>
    function LinkFormatter(value, row, index) {
        return "<button type=\"button\" class=\"btn btn-primary goToChat\" chat=\"" + value + "\">Перейти к чату</button>";
    }
</script>
